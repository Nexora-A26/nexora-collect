...
const config: Record<string,{headers:Record<string,string>;money:string[]}>= {
 representatives:{headers:{code:'الكود',name:'المندوب',customers:'عدد العملاء',operations:'عدد العمليات',collected:'المحصل',commissions:'العمولات',net:'صافي الإدارة',delivered:'المسلم'},money:['collected','commissions','net','delivered']},
 customers:{headers:{code:'الكود',name:'العميل',representative_name:'المندوب',area:'المنطقة',operations:'عدد العمليات',collected:'المحصل',commissions:'العمولات',net:'صافي الإدارة'},money:['collected','commissions','net']},
 collections:{headers:{receipt_number:'الإيصال',collection_date:'التاريخ',representative_name:'المندوب',customer_name:'العميل',amount:'المبلغ',commission_percentage:'النسبة %',commission_amount:'العمولة',net_amount:'صافي الإدارة',payment_method:'الدفع',status:'الحالة'},money:['amount','commission_amount','net_amount']},
 commissions:{headers:{receipt_number:'الإيصال',collection_date:'التاريخ',representative_name:'المندوب',customer_name:'العميل',amount:'المبلغ',commission_percentage:'النسبة %',commission_amount:'العمولة',net_amount:'صافي الإدارة',payment_method:'الدفع',status:'الحالة'},money:['amount','commission_amount','net_amount']},
